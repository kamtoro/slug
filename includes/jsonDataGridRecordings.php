...
try {
    ...
    $sql="SELECT id, replace(source,'\"','' ) as source, location, format, title, subtitle, person, urn, time,  DATE_FORMAT(time,'%d/%m/%Y') AS 'dateUpdated' FROM recordings WHERE $where ORDER BY $order_by $limit";
